export const Features = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#030303] px-4 py-16 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {/* Step 1 */}
          <div className="bg-white dark:bg-gray-900/50 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:border-blue-500/50 transition-all duration-300">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">Enter Your Long URL</h2>
                ...
                <div className="bg-gray-100 dark:bg-gray-950 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          {/* Step 2 */}
          <div className="bg-white dark:bg-gray-900/50 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:border-purple-500/50 transition-all duration-300">
            <div className="flex items-start gap-4">
          ...
          {/* Step 3 */}
          <div className="bg-white dark:bg-gray-900/50 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:border-pink-500/50 transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-r from-pink-500 to-blue-500 flex items-center justify-center text-white font-bold text-xl">
                3
              </div>
              <div className="flex-1">
          ...
          {/* Step 4 */}
          <div className="bg-white dark:bg-gray-900/50 rounded-2xl p-8 border border-gray-200 dark:border-gray-800 hover:border-green-500/50 transition-all duration-300">
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-r from-green-500 to-blue-500 flex items-center justify-center text-white font-bold text-xl">
                4
              </div>
              <div className="flex-1">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className=" rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Free Usage</h3>
              </div>
            ...
            <div className=" rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Register for More</h3>
              </div>
              <p className="text-gray-400">
            ...
            <div className=" rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Auto Paste</h3>
              </div>
              <p className="text-gray-400">
            ...
            <div className=" rounded-xl p-6 border border-gray-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-xl font-semibold text-white">Time Control</h3>
              </div>
              <p className="text-gray-400">
